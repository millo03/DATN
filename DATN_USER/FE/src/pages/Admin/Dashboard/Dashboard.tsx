...
import { useOrdersOfDay, useOrdersTemporary } from "../../../common/hooks/Order/querry_Order";
...
const MainContent = () => {
  ...
  const { data: orderTemporaryData } = useOrdersTemporary();
  // console.log("productData", productData);
  console.log("orderTemporaryData",orderTemporaryData);
  ...
  const totalPriceOrderDay = orderOfDayData?.reduce(
    (sum: number, order: IOrder) => {
      return sum + order.totalPrice;
    },
    0
  );
  const totalPriceOrderTemporary = orderTemporaryData?.reduce(
    (sum: number, order: IOrder) => {
      return sum + order.totalPrice;
    },
    0
  ...
  return (
    <>
      ...
      <div className=" lg:mx-10">
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 md:gap-6 lg:grid-cols-5 2xl:gap-7.5 lg:mt-24">
          <CardDataStats
            ...
            levelUp
          >
            <div className="bg-[#EFF2F7] rounded-full flex justify-between items-center">
              <svg
                ...
                className="lucide lucide-wallet-cards m-3 "
              >
          ...
          <CardDataStats
            ...
            total={formatCurrency(totalPriceOrderTemporary)}
            rate="0.43%"
            levelUp
          >
            <div className="bg-[#EFF2F7] rounded-full flex justify-between items-center">
          ...
          >
            <div className="fill-[#3C50E0]  bg-[#EFF2F7] rounded-full flex justify-between items-center">
              <svg
                className="fill-primary dark:fill-white m-3 items-start"
                width="28"
                height="28"
                viewBox="0 0 20 22"
                fill="none"
