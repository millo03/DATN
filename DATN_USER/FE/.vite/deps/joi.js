      ...
      return e = { 7629: (e2, t2, r) => {
        ...
        const s = r(375), n = r(8571), a = r(9474), i = r(1687), o = r(8652), l = r(8160), c = r(3292), u = r(6354), f = r(8901), m = r(9708), h = r(6914), d = r(2294), p = r(6133), g = r(1152), y = r(8863), b = r(2036), v = { Base: class {
          ...
          note(...e3) {
            ...
            for (const t3 of e3)
              s(t3 && "string" == typeof t3, "Notes must be non-empty strings");
          ...
          tag(...e3) {
            ...
            for (const t3 of e3)
              s(t3 && "string" == typeof t3, "Tags must be non-empty strings");
        ...
        e2.exports = a.extend({ type: "alternatives", flags: { match: { default: "any" } }, terms: { matches: { init: [], register: c.toSibling } }, args: (e3, ...t3) => 1 === t3.length && Array.isArray(t3[0]) ? e3.try(...t3[0]) : e3.try(...t3), validate(e3, t3) {
          ...
          for (let t4 = 0; t4 < r2.$_terms.matches.length; ++t4) {
            ...
            for (let r3 = 0; r3 < l2.length; ++r3) {
              ...
              if (c2.$_match(n2, a2.nest(c2, `${m}.is`), i2)) {
                if (u2)
                  return u2.$_validate(e3, a2.nest(u2, `${m}.then`), i2);
              } else if (f)
                return f.$_validate(e3, a2.nest(f, `${m}.otherwise`), i2);
            }
          }
          ...
          for (const { reports: a2, schema: i2 } of e3) {
            ...
            "base" === f ? s2.add(c2) : n2.push({ type: i2.type, report: o2 });
          }
        ...
        e2.exports = i.extend({ type: "array", flags: { single: { default: false }, sparse: { default: false } }, terms: { items: { init: [], manifest: "schema" }, ordered: { init: [], manifest: "schema" }, _exclusions: { init: [] }, _inclusions: { init: [] }, _requireds: { init: [] } }, coerce: { from: "object", method(e3, { schema: t3, state: r2, prefs: s2 }) {
          ...
          for (let a3 = 0; a3 < h; ++a3) {
            ...
            for (const e4 of t3.$_terms._exclusions)
              if (e4.$_match(o2, s2.localize(y, b, e4), n2, { presence: "ignore" })) {
                if (m.push(r2("array.excludes", { pos: a3, value: o2 }, s2.localize(y))), n2.abortEarly)
                  return m;
                d = true, l2.shift();
                break;
              }
              ...
              if (l2.length) {
                ...
                if (u2.errors) {
                  if (m.push(...u2.errors), n2.abortEarly)
                    return m;
                } else if ("strip" === i3._flags.result)
            ...
            for (let l3 = 0; l3 < _; ++l3) {
              ...
              if (v[l3] = f2, !f2.errors) {
                if (u2.commit(), e3[a3] = f2.value, p = true, c.fastSplice(i2, l3), --l3, --_, !t3._flags.sparse && void 0 === f2.value && (m.push(r2("array.sparse", { key: g, path: y, pos: a3, value: void 0 }, s2.localize(y))), n2.abortEarly))
                  return m;
                break;
              }
              u2.restore();
            ...
            if (!d && (t3.$_terms._inclusions.length || t3.$_terms._requireds.length) && !p) {
              ...
              if (m.push(r2("array.includes", { pos: a3, value: o2 }, s2.localize(y))), n2.abortEarly)
                return m;
            }
          }
        ...
        e2.exports = o.extend({ type: "_keys", properties: { typeof: "object" }, flags: { unknown: { default: false } }, terms: { dependencies: { init: null }, keys: { init: null, manifest: { mapped: { from: "schema", to: "key" } } }, patterns: { init: null }, renames: { init: null } }, args: (e3, t3) => e3.keys(t3), validate(e3, { schema: t3, error: r2, state: s2, prefs: n2 }) {
          ...
          if (t3.$_terms.keys) {
            ...
            for (const o2 of t3.$_terms.keys) {
              ...
              if (u2.errors) {
                ...
                "strip" === o2.schema._flags.result || void 0 === u2.value && void 0 !== l2 ? delete e3[t4] : void 0 !== u2.value && (e3[t4] = u2.value);
            }
          }
          ...
          if (t3.$_terms.dependencies)
            for (const r3 of t3.$_terms.dependencies) {
              if (null !== r3.key && false === h.isPresent(r3.options)(r3.key.resolve(e3, s2, n2, null, { shadow: false })))
                continue;
          ...
          if (a2.length !== o2 && i2.length !== o2)
            return { code: "object.and", context: { present: i2, presentWithLabels: h.keysToLabels(e3, i2), missing: a2, missingWithLabels: h.keysToLabels(e3, a2) } };
        }, nand(e3, t3, r2, s2, n2) {
          ...
          for (const i2 of t3.peers)
            if (false === a2(i2.resolve(r2, s2, n2, null, { shadow: false })))
              return { code: "object.with", context: { main: t3.key.key, mainWithLabel: h.keysToLabels(e3, t3.key.key), peer: i2.key, peerWithLabel: h.keysToLabels(e3, i2.key) } };
        }, without(e3, t3, r2, s2, n2) {
          const a2 = h.isPresent(t3.options);
          for (const i2 of t3.peers)
            if (a2(i2.resolve(r2, s2, n2, null, { shadow: false })))
              return { code: "object.without", context: { main: t3.key.key, mainWithLabel: h.keysToLabels(e3, t3.key.key), peer: i2.key, peerWithLabel: h.keysToLabels(e3, i2.key) } };
        }, xor(e3, t3, r2, s2, n2) {
          const a2 = [], i2 = h.isPresent(t3.options);
          for (const e4 of t3.peers)
            i2(e4.resolve(r2, s2, n2, null, { shadow: false })) && a2.push(e4.key);
              ...
              for (let f2 = 0; f2 < e3.$_terms.patterns.length; ++f2) {
                ...
                if (m2.regex) {
                  ...
                  if (n2.mainstay.tracer.debug(n2, "rule", `pattern.${f2}`, e4 ? "pass" : "error"), !e4)
                    continue;
                } else if (!m2.schema.$_match(i3, n2.nest(m2.schema, `pattern.${f2}`), a2))
                  continue;
                r2.delete(i3);
                ...
                if (m2.matches && o2[f2].push(i3), t3[i3] = d.value, !m2.fallthrough)
                  break;
              }
            }
            if (i2)
        ...
        e2.exports = n.extend({ type: "number", flags: { unsafe: { default: false } }, coerce: { from: "string", method(e3, { schema: t3, error: r2 }) {
          ...
          if (0 === s2.value && (s2.value = 0), !t3._flags.unsafe)
            if (e3.match(/e/i)) {
              if (i.extractSignificantDigits(e3) !== i.extractSignificantDigits(String(s2.value)))
                return s2.errors = r2("number.unsafe"), s2;
            } else {
        ...
        e2.exports = u.extend({ type: "string", flags: { insensitive: { default: false }, truncate: { default: false } }, terms: { replacements: { init: null } }, coerce: { from: "string", method(e3, { schema: t3, state: r2, prefs: s2 }) {
          ...
          if (i2 && i2.args.enabled && (e3 = e3.trim()), t3.$_terms.replacements)
          ...
          if (t3._flags.truncate) {
            ...
            if (n3) {
              ...
              if (f.isResolvable(a3) && (a3 = a3.resolve(e3, r2, s2), !f.limit(a3)))
          ...
          if (s2) {
            ...
            if ("base64" !== s2[2])
              return e3;
            if (m.base64Regex[r2.paddingRequired].false.test(s2[3]))
              return e3;
          }
          ...
          if (true === e3.tlds || void 0 === e3.tlds)
            return s(m.tlds, "Built-in TLD list disabled"), Object.assign({}, e3, m.tlds);
          s("object" == typeof e3.tlds, "tlds must be true, false, or an object");
          const t3 = e3.tlds.deny;
          if (t3)
            return Array.isArray(t3) && (e3 = Object.assign({}, e3, { tlds: { deny: new Set(t3) } })), s(e3.tlds.deny instanceof Set, "tlds.deny must be an array, Set, or boolean"), s(!e3.tlds.allow, "Cannot specify both tlds.allow and tlds.deny lists"), m.validateTlds(e3.tlds.deny, "tlds.deny"), e3;
        ...
        t2.entry = function(e3, t3, r2) {
          ...
          if (l2.validate) {
            ...
            if (t4 && (r2.mainstay.tracer.value(r2, "base", e3, t4.value), e3 = t4.value, t4.errors)) {
              if (!Array.isArray(t4.errors))
                return m.push(t4.errors), u.finalize(e3, m, i2);
              if (t4.errors.length)
                return m.push(...t4.errors), u.finalize(e3, m, i2);
            }
          }
          ...
          for (const i2 of s2._rules) {
            ...
            if (m.errors) {
              ...
              n2.mainstay.tracer.log(s2, n2, "rule", i2.name, "pass"), n2.mainstay.tracer.value(n2, "rule", e3, m.value, i2.name), e3 = m.value;
          }
        ...
        e2.exports = function(e3, ...t3) {
          if (!e3) {
            if (1 === t3.length && t3[0] instanceof Error)
              throw t3[0];
            throw new s(t3);
          }
        };
        ...
        "use strict";
        e2.exports = JSON.parse('{"version":"17.12.3"}');
      } }, t = {}, function r(s) {
        var n = t[s];
        if (void 0 !== n)
          return n.exports;
